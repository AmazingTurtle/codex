...
pub(crate) const EXTERNAL_AGENT_CONFIG_MIGRATION_DAEMON_UNAVAILABLE_MESSAGE: &str = "Import from other apps is unavailable while Better Codex is connected to the local app-server daemon. Stop the daemon, restart Codex, and run /import.";
