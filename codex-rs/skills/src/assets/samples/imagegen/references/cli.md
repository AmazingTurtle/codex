...
Set a stable path to the skill CLI (default `BETTER_CODEX_HOME` is `~/.better-codex`):

```
export BETTER_CODEX_HOME="${BETTER_CODEX_HOME:-$HOME/.better-codex}"
export IMAGE_GEN="$BETTER_CODEX_HOME/skills/.system/imagegen/scripts/image_gen.py"
```
