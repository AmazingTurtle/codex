...
impl OAuthStoreLock {
    ...
    fn acquire_with_timeout(
        ...
        // authority. Those stores are BETTER_CODEX_HOME-backed today: if BETTER_CODEX_HOME is unset they use
...
pub(super) enum OAuthStoreLockFailure {
    #[error("failed to resolve BETTER_CODEX_HOME for MCP OAuth {store} aggregate-store lock")]
    CodexHome {
        store: OAuthStore,
        #[source]
        source: io::Error,
